...
for product in products:
    CSO_path='/Users/santiago/Documents/MODIS/CSO/'+product
            ...
            for day in dayfolders:
                ...
                for file_name in onlyfiles[1:]:
                    if file_name[0:8]==product:
                        ...
                        a=a+1
                        #print(a)
    pd.DataFrame.from_dict(list_CSO).to_csv('/Users/santiago/Documents/MODIS/CSO/listing_modis_'+product+'.csv',sep=';',index=False)