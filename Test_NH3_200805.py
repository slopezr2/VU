...
gridded_nh3.graph_map(variable='yr',facecolor=(1,1,1),biascorr=17.03052*1000,vmin=0,vmax=5,n_levels_plot=10,cmap=redgreen,type_graph='mean',ini_period=0,end_period=10,date=False,save=True,title='IASI NH$_{3}$ total column',ocean=True)
