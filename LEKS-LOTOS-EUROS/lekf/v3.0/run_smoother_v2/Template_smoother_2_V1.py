...
#==1. Define path to run the LE simulation===
LE.run_path = '/scratch-shared/slr/projects/Smoother_V2/'

#==2. Definition of the assimilation window==
...
#==3. Define id simulation name and dates of the==
LE.ID = 'Test_New_V2'
start_date = '2008-05-01 00:00:00'
Ncycles = 3			#Number of assimilation cycles.

#==4. Number of ensembles and localization radius==
LE.Nens = 3
radius = 1 #Degree
#==5. CSO instrument outputs to be assimilated==
#=Available operators=
# polder-aod-443 polder-aod-865 polder-ssa-563 polder-aaod aeronet-aod-500 aeronet-aod-440 aeronet-aod-870 modis-terra modis-aqua emep-pm10 emep-pm25 iasi-nh3 iasi-so2
CSO_instruments = ['polder-aod', 'polder-ae', 'polder-ssa-563']

#==6. Using spatial correlation for perturbation factor===
spatial_corr = True
