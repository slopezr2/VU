...
!  end subroutine GO_Comm_GetID
  ...
  ! Return total size (output dimension) and start index in output array.
  !

  subroutine GO_Comm_ParInfo( self, n, ntot, istart, status )
    ...
    ! number of data values for each processor:
