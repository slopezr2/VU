      ...
      do iy = 1, ny
        if (lu_fracs(ix,iy,ilu_water_sea) > 0.0) then
          ...
          do itr = 1, n_basecation
            ...
            ! switch:
            select case ( ispec )
              case(ispec_Na_f1)  ! already done as part of seasalt
              case(ispec_Na_f2)  ! already done as part of seasalt
              case(ispec_Na_c1)  ! already done as part of seasalt
              case(ispec_Na_c2)  ! already done as part of seasalt
              case(ispec_Na_c3)  ! already done as part of seasalt
