...
def WriteSource_Indices( indices_inc, rcf, specs ) :
    ...
    lines.append('   integer, parameter              ::  AEROSOL_F1_MODE     = 4' )
    lines.append( '  integer, parameter              ::  AEROSOL_FINE_MODE   = 5' )
    lines.append( '  integer, parameter              ::  AEROSOL_C1_MODE     = 6' )
    lines.append( '  integer, parameter              ::  AEROSOL_C2_MODE     = 7' )
    ...
    for itr in range(specs.nspec) :
        ...
        if 'aerosol' in specs.props[itr] :
            ...
            elif 'f1_mode' in specs.props[itr] :
                mode = 'AEROSOL_F1_MODE '
            elif 'fine_mode' in specs.props[itr] :
                mode = 'AEROSOL_FINE_MODE '
            elif 'c1_mode' in specs.props[itr] :
                mode = 'AEROSOL_C1_MODE'
            elif 'c2_mode' in specs.props[itr] :
                mode = 'AEROSOL_C2_MODE'                           
...
#    lines.append( '!  public  ::  ireac0_het' )
    ...
    lines.append( '' )
    #Santiago
    lines.append( '  ! Santiago, Reaction indice needed for SO2 perturbation' )
    lines.append( '  public    ::  ireac_R71' )
    lines.append( '' )
    lines.append( '  ! --- const ------------------------------------' )
    lines.append( '' )
