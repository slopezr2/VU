  ...
  subroutine LE_CF_names( name, unit, &
    ...
    select case ( name )
      ...
      case ( 'ppm_f', 'ppm_c' )
        ...
        cf_spec_long = 'PPM2.5'
        cf_units     = 'kg m-3'
      case ( 'na_f2', 'na_c3', 'na_f1','na_c1','na_c2' )
        cf_type      = 'tracer'
        cf_spec_stnd = ''         ! not available yet ...
        cf_spec_long = 'sodium'
        cf_units     = 'kg m-3'
      case ( 'dust_f2', 'dust_c3', 'dust_f1', 'dust_c1','dust_c2' )
        cf_type      = 'tracer'
      ...
      case ( 'tpmfire')
        cf_type      = 'tracer'
        cf_spec_stnd = ''         ! not available yet ...
        cf_spec_long = 'TPM10_fire'
        cf_units     = 'kg m-3'
      case ( 'tpmfire_f')
        cf_type      = 'tracer'
        cf_spec_stnd = ''         ! not available yet ...
        cf_spec_long = 'TPM25_fire'
        cf_units     = 'kg m-3' 
      case ( 'tpmfire_c')
        cf_type      = 'tracer'
        cf_spec_stnd = ''         ! not available yet ...
        cf_spec_long = 'TPM_fire_coarse'
        cf_units     = 'kg m-3'
