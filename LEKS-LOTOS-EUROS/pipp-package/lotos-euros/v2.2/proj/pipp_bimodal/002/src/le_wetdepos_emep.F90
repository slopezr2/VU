...
contains
  ...
  subroutine LE_WetDepos_Emep_Apply( c, cwet, update_cwet, deltat, status )
    ...
    use indices     , only : NO_AEROSOL_MODE, AEROSOL_FINE_MODE, AEROSOL_COARSE_MODE
    use indices     , only : AEROSOL_F1_MODE, AEROSOL_C1_MODE, AEROSOL_C2_MODE
#ifdef with_m7
...
#endif
                case ( AEROSOL_FINE_MODE  )          ; scav_efficiency = 0.1              
                case ( AEROSOL_F1_MODE  )            ; scav_efficiency = 0.1
                case ( AEROSOL_C1_MODE )             ; scav_efficiency = 0.4
                case ( AEROSOL_C2_MODE )              ; scav_efficiency = 0.4
