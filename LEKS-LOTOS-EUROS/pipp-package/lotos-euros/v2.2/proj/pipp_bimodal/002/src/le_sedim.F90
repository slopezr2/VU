...
contains
  ...
  subroutine LE_Sedim_Apply( c, bud, update_bud, dt_sec, status )
    ...
    use Indices           , only : specmode, AEROSOL_FINE_MODE, AEROSOL_COARSE_MODE
    use Indices           , only : specmode, AEROSOL_F1_MODE, AEROSOL_C2_MODE,AEROSOL_C1_MODE
    ...
    do i_aerosol = 1, n_aerosol
      ...
      select case ( specmode(ispec) )
        ...
        ! fine modes:
        case ( AEROSOL_FINE_MODE, AEROSOL_F1_MODE, &
#ifdef with_m7
        ...
        ! coarse mode:
        case ( AEROSOL_COARSE_MODE, AEROSOL_C2_MODE, AEROSOL_C1_MODE, &
#ifdef with_pollen        
               AEROSOL_POLLEN_MODE, &
#endif              
