        ...
        select case ( trim(LE_Dat(idat)%name) )
          ...
          case('drysox_lu')
            ...
            do ibud_spec = 1, accum_n(ispec_soxa)
              convfact = 1.0
              if (accum_ppb_to_ugm3(ispec_soxa,ibud_spec) ) convfact = dens(1:nx,1:ny,1)/xm_air
          ...
          case('drynoy_lu')
            ...
            do ibud_spec = 1, accum_n(ispec_noya)
              convfact = 1.0
              if (accum_ppb_to_ugm3(ispec_noya,ibud_spec) ) convfact = dens(1:nx,1:ny,1)/xm_air
          ...
          case('drynhx_lu')
            ...
            do ibud_spec = 1, accum_n(ispec_nhxa) 
              convfact = 1.0
              if (accum_ppb_to_ugm3(ispec_nhxa,ibud_spec) ) convfact = dens(1:nx,1:ny,1)/xm_air
