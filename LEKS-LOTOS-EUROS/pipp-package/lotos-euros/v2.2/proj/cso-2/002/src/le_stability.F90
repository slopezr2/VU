     ...
     do j=1,ny
      ...
      if ( (htop < 10.0) .or. (htop > 60.0) ) then
       ...
       do ilu = 1, nlu
         ...
         ! increase Ra value above snow
         if ( sd(i,j,1) > substantial_snowdepth ) then
           Ra_h_htop_zcanopytop_lu(i,j,ilu) = Ra_h_htop_zcanopytop_lu(i,j,ilu) + 3000.
         end if
         ...
         ! increase Ra value above snow
         if ( sd(i,j,1) > substantial_snowdepth ) then
           Ra_h_htop_z0_lu(i,j,ilu) = Ra_h_htop_z0_lu(i,j,ilu) + 3000.
         end if
         ...
         ! increase Ra value above snow
         if ( sd(i,j,1) > substantial_snowdepth ) then
           Ra_h_htop_zobs_lu(i,j,ilu) = Ra_h_htop_zobs_lu(i,j,ilu) + 500.
         end if                
         ...
         ! increase Ra value above snow
         if ( sd(i,j,1) > substantial_snowdepth ) then
           Ra_h_zcanopytop_z0_lu(i,j,ilu) = Ra_h_zcanopytop_z0_lu(i,j,ilu) + 3000.
         end if
