...
!   for NH3, the 'ready' flag is .true. if nwet==9 (snow covered) or nwet==10 (ice covered)
...
case('HNO3','N2O5','NO3','H2O2')
   ...
   if (t .lt. -5.0 .and. (nwet .eq. 9 .or. nwet.eq.10)) then
     ! T < 5 C and snow:
      rc_tot = 50.
   else
...
case('NO','CO')
      ...
      elseif (nwet .eq. 1) then ! wet
         rc_tot = 2000.
         ready = .true.
      elseif (nwet .eq. 9 .or. nwet.eq.10 ) then ! snow/ice
