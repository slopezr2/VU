...
contains
  ...
  subroutine LE_Particle_Size_Init( status )
    ...
    use Indices    , only : ispec_dust_f1, ispec_dust_f2
    use Indices    , only : ispec_dust_c1, ispec_dust_c2, ispec_dust_c3
#ifdef with_m7
...
#endif
    use Indices    , only : specmode, NO_AEROSOL_MODE, AEROSOL_FINE_MODE, AEROSOL_COARSE_MODE, AEROSOL_All_MODES
    use Indices    , only : AEROSOL_F1_MODE, AEROSOL_C2_MODE, AEROSOL_C1_MODE
    ...
    real, parameter   ::  partsize_f1     = 0.33e-6
    real, parameter   ::  partsize_fine   = 0.7e-6
    real, parameter   ::  partsize_c1     = 3.0e-6
    real, parameter   ::  partsize_c2     = 5.0e-6
    ...
    do i_aerosol = 1, n_aerosol
      ...
      ispec = ispecs_aerosol(i_aerosol)
        ...
        select case ( specmode(ispec) )
          case ( AEROSOL_FINE_MODE )
            partsize(:,:,:,i_aerosol) = partsize_fine  ! m
          case ( AEROSOL_F1_MODE )
            partsize(:,:,:,i_aerosol) = partsize_f1  ! m
          case ( AEROSOL_C1_MODE )
            partsize(:,:,:,i_aerosol) = partsize_c1   ! m
          case ( AEROSOL_C2_MODE )
            partsize(:,:,:,i_aerosol) = partsize_c2   ! m
          case ( AEROSOL_COARSE_MODE )
  ...
  subroutine SlipCor_Update( status )
    ...
    !use Indices      , only : AEROSOL_FINE_MODE, AEROSOL_COARSE_MODE
    use JAQL_drydeposition, only : Slip_Correction_Factor

    use indices      , only : ispec_dust_c3
