        ...
        ! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
          ...
          do ifield = 1, nheader
            ...
            select case ( trim(header) )
              ...
              ! Sector name (used in emission model combined with fuels)
              case ( 'Sector_Fuel' )
                ! store field index
          ...
          ! check index:
          if ( ifield_cat < 0 .and. ifield_sector < 0 ) then
          ...
          do
            ...
            if ( ifield_sector > 0 ) then
              ! search
              call goMatchValue( fields(ifield_sector), cat_codes, icat, status )
              IF_NOTOK_RETURN(status=1)              
