...
!    ! Every time a call to 'Num_Random_Get_Normal' the seed is reset actually,
...
module Num_Random
  ...
  contains
    procedure ::  Init          =>  Num_Random_Init
    procedure ::  Done          =>  Num_Random_Done
    !
    procedure ::                    Num_Random_Get_Normal_0d
    procedure ::                    Num_Random_Get_Normal_1d
    generic   ::  Get_Normal    =>  Num_Random_Get_Normal_0d, &
                                    Num_Random_Get_Normal_1d
    !
  end type T_Random
...
contains
  ...
  subroutine Num_Random_Init( self, seed0, status )
    ...
    character(len=*), parameter   ::  rname = mname//'/Num_Random_Init'
  ...
  end subroutine Num_Random_Init
  
  !
  ! done
  !
  
  subroutine Num_Random_Done( self, status )
    ...
    character(len=*), parameter   ::  rname = mname//'/Num_Random_Done'
  ...
  end subroutine Num_Random_Done
  
  !
  ! Reset seed given current number of calls
  !
  
  subroutine Num_Random_ResetSeed( self, status )
    ...
    character(len=*), parameter   ::  rname = mname//'/Num_Random_ResetSeed'
  ...
  end subroutine Num_Random_ResetSeed
  ...
  subroutine Num_Random_Get_Normal_0d( self, x, status, &
                                     mu, sigma )
    ...
    character(len=*), parameter   ::  rname = mname//'/Num_Random_Get_Normal_0d'
    ...
    ! reset seed:
    call Num_Random_ResetSeed( self, status )
    IF_NOTOK_RETURN(status=1)
  ...
  end subroutine Num_Random_Get_Normal_0d
  
  ! *
  
  subroutine Num_Random_Get_Normal_1d( self, x, status, &
                                     mu, sigma )
    ...
    character(len=*), parameter   ::  rname = mname//'/Num_Random_Get_Normal_1d'
  ...
  end subroutine Num_Random_Get_Normal_1d
