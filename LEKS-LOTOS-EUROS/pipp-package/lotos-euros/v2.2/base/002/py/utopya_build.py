...
class UtopyaDependencies( utopya_rc.UtopyaRc ) :
    ...
    def GetLines( self, flags='', files='*.[Ff]*', expl={} ) :
        ...
        * `MakeDepF90 repository <https://github.com/outpaddling/makedepf90>`_
        ...
        * 'expl': Dictionairy with explicit dependencies that are otherwise
        ...
        try :
            ...
            self.logger.error( '  https://github.com/outpaddling/makedepf90' )
            self.logger.error( '*******************************************************')
            self.logger.error( '')
        ...
        self.logger.debug( '    WARNING - and makedepf90 does not like the DOS format ...' )
        self.logger.debug( '    ' )
